        ...
        <div className="page-container">
            ...
            <div className="model-page-row">
                ...
                <div className="model-page-column">
                    ...
                    <p className="no-margin-p">ATP Leverancemodel finder du via <Link to="/forretningsgangehuset">Huset - Sådan gør vi...</Link>
                    <br /><br />
            ...
            <div className="model-page-row">
                ...
                <div className="model-page-column">
                    ...
                    <br /><br />
                    Forandringsuniverset finder du under ATP Leverancemodel. Værktøjskasser. Find ATP Leverancemodel i <Link to="/forretningsgangehuset">Huset - Sådan gør vi...</Link>
                    </p>
                </div>
            </div>
            <div className="model-page-row">
                <div className="model-page-column model-page-column-full">
                    ...
                    <p className="no-margin-p">
                        IT-Operating Model (ITOM) finder du via <Link to="/forretningsgangehuset">Huset - Sådan gør vi... </Link>
                        under Koncern IT.
                    <br /><br />
